    ...
    <div className="folio-shell" data-ui-tone={uiTone}>
      <header className="folio-commandbar">
        ...
        <nav aria-label="Application commands">
          <button onClick={() => setShowBookDetails(true)}>Book</button>
          <button onClick={() => setShowContent(true)}>Add</button>
          <button onClick={() => setShowStyle(true)}>Design</button>
          <button onClick={() => setUiTone((tone) => tone === "ivory" ? "midnight" : "ivory")}>Appearance</button>
          <button onClick={() => setShowGenerate(true)}>Export</button>
        </nav>
      ...
      <aside className="library-pane">
        <div className="library-toolbar"><span className="pane-label">Manuscript</span><div className="library-toolbar-actions"><button className="toolbar-text-button" title="Add content" onClick={() => setShowContent(true)}><UiIcon name="add"/>Add</button><button className="icon-button" title="Book design" aria-label="Book design" onClick={() => setShowStyle(true)}><UiIcon name="design"/></button></div></div>
        ...
        <div className="library-footer"><button className="tiny-footer-button footer-add" title="Add chapter or book matter" aria-label="Add chapter or book matter" onClick={() => setShowContent(true)}><UiIcon name="add"/></button><button className="tiny-footer-button" title="Open another book" aria-label="Open another book" onClick={() => void openFolder()}><UiIcon name="open"/></button><button className="tiny-footer-button" title="Reload files" aria-label="Reload files" onClick={() => void reloadFiles()}><UiIcon name="reload"/></button><div className="library-footer-spacer"/><button className="tiny-footer-button" title="Book details" aria-label="Book details" onClick={() => setShowBookDetails(true)}><UiIcon name="info"/></button></div>
      </aside>
