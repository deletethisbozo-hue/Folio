...
const PROFILES: Record<string, ReflowProfile> = {
  ...
  // Paperwhite uses a 22.5px side inset (~5.5% of the logical viewport). This
  // keeps the reading measure inside the overlap where both Polish paragraphs
  // compose under Folio's strict microtype limits without ragged rescue.
  "kindle-paperwhite": { width: 412, height: 549, baseFont: 18, padding: [34, 22.5, 46, 22.5], wordsPerPage: 270 },
