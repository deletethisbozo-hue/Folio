...
const PROFILES: Record<string, ReflowProfile> = {
  ...
  // Paperwhite Standard uses a calm 32px logical side inset. At the 18px
  // reading preset this keeps the measure in a book-like range where the
  // compositor can choose natural word breaks without inflating word space.
  "kindle-paperwhite": { width: 412, height: 549, baseFont: 18, padding: [34, 32, 46, 32], wordsPerPage: 270 },
